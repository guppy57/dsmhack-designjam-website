      ...
      <div className="max-w-6xl mx-auto z-20 relative px-4">
        ...
        >
          ...
          >
            ...
            <span className="text-[#008EA3]">nonprofits</span> together to build
            a more beautiful and helpful{" "}
          ...
          >
            24 hour event where designers pair with non-profits to redesign
            logos, tweak websites, and beautify branding.
          </motion.p>
          <motion.div
          ...
          >
            <Button
              style="primary"
              href="https://www.eventbrite.com/e/design-jam-2026-tickets-1980427344499"
              text="Designer registration"
            />
            <Button
              style="secondary"
              href="https://docs.google.com/forms/d/e/1FAIpQLSe8pmb8Oth5nd9hoZGrcpqy_MmmI3IdW9ZxHrgoaKAeEyjKSg/viewform"
              text="Nonprofit application"
            />
          </motion.div>
        </motion.div>
            ...
            >
              <BentoCard className="flex flex-col items-start justify-between">
                ...
                <p className="text-md md:text-lg mt-4">
                  ...
                  Since 2014, we've provided over $1.4 million in in-kind
                  services to 78+ organizations, proving that technology and
                  design should never be barriers to doing good.
                </p>
              </BentoCard>
            </motion.div>
          </motion.div>
                  ...
                  <div>
                    ...
                    <div className="mb-4 pl-4 border-l-4 border-[#0AD1EE]">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <span className="bg-[#C7F0F6] text-[#047481] text-xs font-medium px-3 py-1 rounded-full">
                          Mission & values
                        </span>
                        <span className="bg-[#C7F0F6] text-[#047481] text-xs font-medium px-3 py-1 rounded-full">
                          Logo design
